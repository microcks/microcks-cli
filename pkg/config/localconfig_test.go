...
func TestGetUserReturnsReferenceToStoredEntry(t *testing.T) {
    cfg := LocalConfig{Users: []User{{Name: "http://localhost:8080", AuthToken: "old-token"}}}
...
func TestGetServerReturnsReferenceToStoredEntry(t *testing.T) {
    cfg := LocalConfig{Servers: []Server{{Server: "http://localhost:8080", KeycloakEnable: true}}}
...
func TestGetInstanceReturnsReferenceToStoredEntry(t *testing.T) {
    cfg := LocalConfig{Instances: []Instance{{Name: "microcks", Status: "Exited"}}}
...
func TestGetAuthReturnsReferenceToStoredEntry(t *testing.T) {
    cfg := LocalConfig{Auths: []Auth{{Server: "http://localhost:8080", ClientId: "id-a"}}}
