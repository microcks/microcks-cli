 ...
 */
 ...
 // GetTestResultDetails fetches the full test result including per-operation TestCaseResults.
 // Used by --output-format=github-actions to emit workflow annotations.
