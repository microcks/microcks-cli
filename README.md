...
Current development version is `1.0.4`. It is available as a container image named `quay.io/microcks/microcks-cli:nightly`.
...
Visit the [Release page](https://github.com/microcks/microcks-cli/releases/tag/1.0.3), browse the **Assets** and download the one matching your platform
